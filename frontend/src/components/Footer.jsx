...
const Footer = () => {
  return (
    <div className=" bg-gray-200 text-black rounded-t-3xl mt-8 md:mt-0">
      ...
      <div>
        {/* <p className=" text-center py-4"> Designed & Developed by Nerdy Devs
          @copyright developed by
          <span className=""> champion programmers</span> | All
          rights reserved
        </p> */}
