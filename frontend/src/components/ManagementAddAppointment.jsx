...
const ManagementAddAppointment = () => {
    ...
    return (
        <div className="flex">
          ...
          <div className="w-[80%] h-[100vh] flex flex-col">
            <ManagementTopnav />
            <div className="relative flex-grow flex items-center justify-center bg-[url('./new_hospital_background.jpg')] bg-cover">
              ...
              <form className="relative bg-white p-10 rounded shadow-lg shadow-[#4AB88B] w-full max-w-xl bg-[#6656cd27]">
                <h2 className="text-3xl font-bold mb-6 text-center text-[#4AB88B]">Add Appointment</h2>
...
export default ManagementAddAppointment