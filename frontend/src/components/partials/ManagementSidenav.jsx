    ...
    return (
        <div className="w-[20%] h-[100vh] border-r-2 border-zinc-400 p-10 overflow-y-auto">
          ...
          <nav className='flex flex-col text-zinc-400 text-xl gap-3'>
            ...
            <Link to="/SeeAllAppointment" className='hover:bg-[#6556CD] hover:text-black duration-300 rounded-lg p-5'><i className="mr-2 ri-fire-fill"></i>Current Appointment</Link>
            <Link to="/MakeAppointmentManagement" className='hover:bg-[#6556CD] hover:text-black duration-300 rounded-lg p-5'><i className="mr-2 ri-bard-fill"></i>Make Appointment</Link>
